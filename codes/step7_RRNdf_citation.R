...
capture.output(utils:::print.bibentry(citation("randomForest"), style = "Bibtex"),
               file = "randomForest.bib")


capture.output(utils:::print.bibentry(citation("maps"), style = "Bibtex"),
               file = "maps.bib")


capture.output(utils:::print.bibentry(citation("PMCMRplus"), style = "Bibtex"),
               file = "PMCMRplus.bib")
